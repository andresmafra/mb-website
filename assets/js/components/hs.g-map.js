    ...
    initGMap: function (sel, lat, lng) {
      ...
      this.collection.each(function (i, el) {
        ...
        var $this = $(el),
          ...
          gMapDisableDefaultUI = $this.data('disable-default-ui'),
          ...
          if(!!lat && !!lng) {
            gMapLat = parseFloat(lat);
            gMapLng = parseFloat(lng);
          }
        ...
        if (gMapType == 'satellite') {
          ...
          $gMap = new GMaps({
            ...
            lng: gMapLng,
            zoom: gMapZoom ? gMapZoom : config['zoom'],
            disableDefaultUI: gMapDisableDefaultUI ? gMapDisableDefaultUI : false,
            scrollwheel: config['scrollwheel']
          });
