    ...
    initRangeDatepicker: function () {
      ...
      this.collection.each(function (i, el) {
        ...
        var $this = $(el),
          ...
          optIsDisableWeekendsDates = $this.data('rp-is-disable-weekends-dates'),
          optIsDisablePastDates = $this.data('rp-is-disable-past-dates');
        ...
        $this.flatpickr({
          ...
          disable: [
            function (date) {
              const pastDate = optIsDisablePastDates && date.getTime() < new Date().getTime()
              const weekends = optIsDisableWeekendsDates && date.getDay() === 0 || date.getDay() === 6
              return pastDate || weekends;
            }
          ],
          // locale: {
          //   firstDayOfWeek: 1,
